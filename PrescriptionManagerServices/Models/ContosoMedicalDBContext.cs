...
namespace PrescriptionManagerServices.Models
{
    ...
    {
        //public ContosoMedicalDBContext()
        //{
        //}

        public ContosoMedicalDBContext(DbContextOptions<ContosoMedicalDBContext> options)
            : base(options)
        {
        }
